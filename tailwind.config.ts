  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        overline: ["0.6875rem", { lineHeight: "1.4", letterSpacing: "0.15em", fontWeight: "600" }],
      },
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": {
            boxShadow:
              "0 4px 0 0 hsl(var(--primary) / 0.3), 0 0 15px hsl(var(--primary) / 0.2)",
          },
          "50%": {
            boxShadow:
              "0 4px 0 0 hsl(var(--primary) / 0.4), 0 0 25px hsl(var(--primary) / 0.4)",
          },
        },
      },
