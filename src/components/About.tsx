      ...
      <ScrollFade>
        <div className="container relative z-10 mx-auto max-w-2xl glass rounded-xl p-card md:p-container shadow-soft">
          ...
          <div className="mb-container md:mb-container-lg">
            ...
            <TooltipProvider>
              <div className="flex-wrap flex items-start justify-center gap-[10px]">
                {/* Medium Button */}
                <Tooltip>
                  <TooltipTrigger asChild>
                    ...
                    scale: 0.98
                      ...
                      <span className="text-caption text-secondary-foreground">AI ethics essays</span>
                    </motion.a>
                  </TooltipTrigger>
                  <TooltipContent>
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    ...
                    scale: 0.98
                      ...
                      <span className="text-caption text-secondary-foreground">Ongoing analysis</span>
                    </motion.a>
                  </TooltipTrigger>
                  <TooltipContent>
