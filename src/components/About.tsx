...
function CardFront({ data }: { data: HighlightData }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full w-full p-2 sm:p-3 text-center">
...
function CardBack({ data }: { data: HighlightData }) {
  return (
    <div className="flex flex-col items-center justify-center h-full w-full p-2 sm:p-3 text-center bg-secondary/80 rounded-md">
...
const About = () => {
  return (
    <section id="about" className="py-12 sm:py-16 md:py-20 px-3 sm:px-4 bg-card">
      <div className="container mx-auto max-w-2xl bg-card/80 border border-border/50 shadow-sm rounded-md p-4 sm:p-6">
        ...
        <div className="flex flex-wrap gap-2 sm:gap-3 justify-center">
          {highlights.map((item) => (
            <FlippingCard
              ...
              width={90}
              height={100}
              className="sm:w-[110px] sm:h-[120px] md:w-[130px] md:h-[140px]"
