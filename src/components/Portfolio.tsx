        ...
        <div className="relative flex flex-col flex-1 p-card">
          ...
          {project.live && (
            <a
              ...
              className="portfolio-button inline-flex items-center justify-center gap-2 w-full py-3 px-4 text-body-sm font-medium text-primary-foreground bg-primary rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50 focus:ring-offset-2 focus:ring-offset-card"
