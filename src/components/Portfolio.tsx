...
const Portfolio = () => {
  return <section id="portfolio" className="relative bg-muted/30 overflow-hidden">
      {/* Background elements */}
      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-4">
          <ScrollFade>
            <div className="flex items-center gap-2 pt-section-sm md:pt-section py-[21px]">
        ...
        {/* Gallery Carousel */}
        <Gallery4 title="Case Studies" description="Real-world AI ethics projects showcasing measurable impact in fairness, governance, and responsible technology deployment." items={galleryItems} />
      </div>
    </section>;
};
