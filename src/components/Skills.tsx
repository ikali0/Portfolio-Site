...
const Skills = () => {
  ...
  return (
    <section id="skills" className="py-16 px-5 bg-slate-50/50">
      <div className="container mx-auto max-w-4xl">
        ...
        >
          ...
          <p className="text-slate-500 mt-4 max-w-xl text-sm md:text-base">
                        ...
                        >
                          <div className="flex flex-wrap gap-1 mt-3">
                            {skill.examples.map((ex) => (
                              <span key={ex} className="text-[9px] bg-slate-100 text-slate-600 px-2 py-0.5 rounded-md border border-slate-200">
                                {ex}
                              </span>
                            ))}
                          </div>
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-2">
          {secondaryTech.map((tech) => (
            <span 
              key={tech}
              className="px-4 py-1.5 text-[10px] md:text-xs font-medium text-slate-500 bg-white border border-slate-200 rounded-full shadow-sm"
            >
              {tech}
            </span>
          ))}
