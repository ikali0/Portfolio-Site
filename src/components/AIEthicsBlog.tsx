  ...
  return <motion.a href={article.url} target="_blank" rel="noopener noreferrer" className="group block border border-border/50 bg-card/50 backdrop-blur-sm rounded-lg p-6 
    ...
    scale: 0.995
      ...
      <div className="flex items-start justify-between gap-4 mb-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-md bg-muted/50 flex items-center justify-center">
            <FontAwesomeIcon icon={article.icon} className="w-5 h-5 text-purple-500 bg-[sidebar-accent-foreground] bg-transparent" />
          </div>
          <div>
      ...
      <div className="flex items-center justify-between pt-4 border-t border-border/30">
        ...
        <span className="flex items-center gap-1.5 text-sm group-hover:gap-2 transition-all text-secondary-foreground font-light">
          Read 
