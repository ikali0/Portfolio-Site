    ...
    scale: 0.995
      ...
      <div className="flex items-start justify-between gap-4 mb-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-md flex items-center justify-center bg-secondary border-primary border border-solid">
            <FontAwesomeIcon icon={article.icon} className="w-5 h-5 text-accent-foreground" />
          </div>
          <div>
      ...
      <div className="flex items-center justify-between pt-4 border-t border-border/30">
        ...
        <span className="flex items-center gap-1.5 font-medium group-hover:gap-2 transition-all text-xs text-secondary-foreground">
          Read 
