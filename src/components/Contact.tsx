...
const Contact = () => {
  const services = [
    ...
    { text: "Technical architecture & review", icon: faLightbulb },
        ...
        <ScrollFade>
          <div className="text-center space-y-3">
            ...
            <p className="text-sm sm:text-base text-muted-foreground max-w-lg mx-auto leading-relaxed">
              Open to research collaboration, AI governance work, and technical consulting.
            </p>
          </div>
        </ScrollFade>
                ...
                <ul className="space-y-4">
                  {services.map((service, index) => (
                    ...
                    >
                      <FontAwesomeIcon
                        icon={service.icon}
                        className="text-primary w-4 h-4 mt-1"
                      />
