          ...
          <StaggerItem>
            ...
            damping: 30
              ...
              <div className="retro-title-bar">
                ...
                <div className="gap-1 flex items-start justify-end">
                  <div className="w-3 h-3 rounded-sm bg-secondary" />
                  <div className="w-3 h-3 rounded-sm bg-accent" />
                </div>
              </div>
              <div className="p-card bg-card/70 backdrop-blur-sm px-[20px] py-[20px]">
                <ContactForm />
              </div>
            </motion.div>
          </StaggerItem>
                ...
                <div className="p-card bg-card/70 backdrop-blur-sm">
                  <ul className="space-y-element">
                    ...
                    duration: 0.3
                        ...
                        <FontAwesomeIcon icon={service.icon} className="w-4 h-4 mt-0.5 bg-fuchsia-500 my-0 text-purple-200 border-blue-900 border border-dotted" />
