...
const Hero = () => {
  return (
    <section className="relative min-h-[100svh] flex items-center justify-center overflow-hidden px-4 pt-24 pb-16">
      ...
      <div className="relative z-20 w-full max-w-4xl mx-auto text-center md:text-left flex flex-col items-center md:items-start">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="flex items-center justify-center w-9 h-9 rounded-md border border-[#0A66C2]/30 bg-[#0A66C2]/10 hover:bg-[#0A66C2]/20 transition-colors"
                  aria-label="LinkedIn"
                >
                  <FontAwesomeIcon
                    icon={faLinkedin}
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <motion.a
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="flex items-center justify-center w-9 h-9 rounded-md border border-accent/30 bg-accent/10 hover:bg-accent/20 transition-colors"
                  aria-label="Email"
                >
                  <FontAwesomeIcon
                    icon={faEnvelope}
        ...
        >
          <a
            href="#about"
            className="flex flex-col items-center md:items-start text-muted-foreground hover:text-foreground transition-colors"
          >
