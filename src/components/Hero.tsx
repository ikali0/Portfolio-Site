/**
 * Hero Section – Fully visible, responsive, no clipping
 */
...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="relative z-20 max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          <motion.h1
            {...fadeUp(0.1)}
            className="text-4xl sm:text-5xl md:text-6xl font-display font-bold leading-tight tracking-tight mb-6"
          >
            Building AI systems
            <br />
          ...
          >
            <TooltipProvider>
              ...
              <SocialIcon
                ...
                label="Send an email"
                className="bg-neural/10 border border-neural/30 text-neural hover:bg-neural/20"
                icon={faEnvelope}
              />
            </TooltipProvider>
          </motion.div>
