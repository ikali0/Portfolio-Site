...
const Hero = () => {
  return <section className="relative min-h-[100svh] flex items-center justify-center overflow-hidden px-4 pt-24 pb-16">
      ...
      <div className="relative z-20 w-full max-w-4xl mx-auto text-center md:text-left flex flex-col items-center md:items-start">
        ...
        duration: 0.5
      }} className="inline-block text-xs uppercase tracking-wide rounded-full border border-secondary/25 mb-6 text-lime-100 bg-secondary-foreground px-[8px] py-[8px]">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                scale: 0.95
                  ...
                  <FontAwesomeIcon icon={faEnvelope} className="w-3.5 h-3.5 text-fuchsia-500" />
                </motion.a>
              </TooltipTrigger>
              <TooltipContent>
                Send email
