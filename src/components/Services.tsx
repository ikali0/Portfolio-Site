...
const services = [
  {
    ...
    bullets: [
      "Ship production-ready LLM features",
      "Prevent prompt injection & model abuse",
      "Design scalable RAG architectures",
      "Add lightweight governance early",
      "Prepare for SOC 2 / investor diligence"
    ],
    cta: "Build With Me",
    ctaHref: "#contact"
  },
  {
    ...
    bullets: [
      ...
      "Translate policy into deployable controls",
      "Build audit-ready AI workflows",
      "Conduct adversarial testing",
      "Reduce institutional risk exposure"
    ],
...
export default function Services() {
  ...
  return (
    <section id="services" className="py-16 px-4 bg-background md:py-[88px]">
      <div className="max-w-5xl mx-auto">
        ...
        {!isMobile && (
          <ScrollFade>
            <div 
              ref={containerRef}
              className="relative overflow-hidden rounded-2xl border border-border/40 bg-card shadow-lg h-[480px]"
            >
              <div className="flex h-full">
                ...
                {/* Draggable Divider */}
                <motion.div
                  className="relative z-10 flex items-center justify-center cursor-col-resize group"
                  drag="x"
          ...
          <>
            ...
            <ScrollFade>
              <div className="relative overflow-hidden rounded-2xl border border-border/40 bg-card shadow-lg">
                ...
                >
                  {services.map((service, index) => (
                    <div key={service.id} className="min-w-full p-6 sm:p-8">
  ...
  return (
    <>
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.98 }}
        className={cn(
          "inline-flex items-center gap-2 px-6 py-3 rounded-lg font-semibold text-sm transition-all duration-200 shadow-md",
          index === 0
