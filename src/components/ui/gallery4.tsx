...
const Gallery4 = ({
  ...
  return <section className="py-8 md:py-12 lg:py-16 overflow-hidden">
      ...
      <div className="w-full min-w-0 overflow-hidden" onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
