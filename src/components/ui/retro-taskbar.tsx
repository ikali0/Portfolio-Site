          ...
          <div className="flex items-center gap-2">
            ...
            y: 1
              ...
              <div className="grid grid-cols-2 gap-0.5">
                ...
                <div className="w-2 h-2 rounded-[2px] bg-chart-4/80 bg-secondary-foreground" />
              </div>
              <span className="hidden xs:inline text-xs">Start</span>
            </motion.button>
          </div>
            ...
            {mounted && <Tooltip>
                ...
                scale: 0.95
                  ...
                  ease: "easeInOut"
                      ...
                      {theme === "dark" ? <Moon className="w-4 h-4 text-foreground/70" /> : <Sun className="bg-fuchsia-400 text-yellow-300 rounded-sm shadow-sm opacity-65 border border-solid border-purple-400 h-[12px] w-[12px]" />}
                    </motion.div>
                  </motion.button>
                </TooltipTrigger>
                <TooltipContent>
