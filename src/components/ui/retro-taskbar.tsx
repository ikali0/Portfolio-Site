          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <div className="flex items-center justify-center py-1.5 rounded-lg bg-muted/30 px-[8px] text-secondary-foreground">
              <div className="flex flex-col items-center leading-tight">
                <span className="text-xs font-medium whitespace-nowrap text-primary">{formatTime(currentTime)}</span>
                <span className="text-[10px] hidden xs:block text-secondary">{formatDate(currentTime)}</span>
              </div>
            </div>
          </div>
        </div>
