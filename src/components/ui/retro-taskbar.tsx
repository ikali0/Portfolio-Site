      ...
      <AnimatePresence>
        ...
        duration: 0.15
            ...
            <div className="retro-title-bar">
              ...
              <button onClick={() => setIsStartOpen(false)} className="retro-close-btn" aria-label="Close menu">
                <X className="w-3 h-3" />
              </button>
            </div>
            ...
            {/* Menu items */}
            <div className="p-1">
              {menuItems.map(item => <button key={item.href} onClick={() => handleMenuClick(item.href)} className="retro-menu-item w-full">
            ...
            {/* Shutdown area */}
            <div className="p-2">
              <a href="mailto:altruisticxai@gmail.com" className="retro-menu-item w-full text-sm">
        ...
        <div className="flex items-center justify-between h-full px-1">
          ...
          <div className="gap-1 flex items-start justify-center">
            ...
            <div className="flex items-center gap-1">
              {quickLaunchItems.map(item => <button key={item.href} onClick={() => handleMenuClick(item.href)} className="retro-quick-launch" aria-label={item.label} title={item.label}>
                  {item.icon}
                </button>)}
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            {/* CRT Toggle Button */}
            <button onClick={() => setCrtEnabled(!crtEnabled)} className="retro-quick-launch flex items-center gap-1 px-2" aria-label={crtEnabled ? "Disable CRT effects" : "Enable CRT effects"} title={crtEnabled ? "Disable CRT effects" : "Enable CRT effects"}>
